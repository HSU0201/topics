...
// 全部店家
// $sqlAllshop = $allResult + $waitResult;
                  ...
                  <tbody>
                    <?php foreach ($rows as $row) : ?>
                      <tr>
                        ...
                        <td class="align-middle text-center">
                          <!-- 刪除按鈕，觸發刪除確認視窗 -->
                          <a class="btn btn-danger mx-1" title="下架廠商資料並解除認證" type="button" data-toggle="modal" data-target="#exampleModalLong<?= $row["shop_id"] ?>"><i class="bi bi-ban"></i></a>
                        </td>
                      </tr>
                      <!-- 刪除彈出視窗 -->
