...
<body id="page-top">
  ...
  <div id="wrapper" class="goodnav">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      <!--側邊欄 -品牌-->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="certified-none.php">
      ...
      <!--導航項目 -儀表板-->
      <li class="nav-item">
        <a class="nav-link" href="certified-none.php">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!--插眼-->
        <main>
          <div class="container-fluid d-flex justify-content-center align-items-center" style="position: absolute; top: 25%; left: 7%">
            <div class="dangerous">
              <img src="./asset/img/warning.png" alt="" style="width: 450px" />
            </div>
            <div class="font">
              <span>尚未驗證成功，平台正在驗證中</span>
              <br />
              <br />
              <p>若有任何問題請聯絡客服為您服務！</p>
