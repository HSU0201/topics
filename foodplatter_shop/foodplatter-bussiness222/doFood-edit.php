...
$categorychooseSql= "SELECT * FROM food_category WHERE foodCategory_id=1";
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow d-flex">
              <div class="nav-link" href="#" id="">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Hello! 弘爺漢堡</span>
                <img class="img-profile rounded-circle" src="../img/hy_logo.jpg" />
              </div>
        ...
        <div class="container">
            ...
            <div class="edit-top py-2">
              <a class="btn btn-info" id="btn-color" href="./doUpdatefood.php" title="回商品資訊"><i class="bi bi-arrow-left"></i></a>
            </div>
            <h3 style="font-weight: 800; letter-spacing: 2px;">商品編輯</h3>
            <br>
            ...
            <form action="doUpdatefood.php" method="post">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <img style="max-width:400px" src="../foodimg/<?= $rows["food_img"] ?>" alt="Food Image" id="preview_progressbarTW_img">
                  </div>
                      ...
                      <tr>
                        ...
                        <td>
                          <select class="form-select" name="category_id" aria-label="Default select example">
                            ...
                            <?php foreach($categorychooserows as $categorychooserow):?>
